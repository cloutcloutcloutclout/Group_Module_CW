...
<head>
    ...
    <title>Reply to Message | SkillsBuilder</title>
...
<section class="reply-section">
    <div class="container-fluid page-shell">
        ...
        <div class="topbar-card">
            <div class="page-title">Reply to Message #${msg.id}</div>
            <p class="page-subtitle">Write a reply to the selected message.</p>
        </div>

        <div class="reply-card">
            <div class="section-heading">Reply</div>
            <p class="section-subtitle">Review the original message and send your admin response below.</p>

            <div class="message-preview">
                <div class="message-preview-label">Original message</div>
                <p class="message-preview-text">${msg.message}</p>
            </div>
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin/reply">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="reply" rows="7" class="form-control" required></textarea>
                </div>

                <div class="d-flex gap-2 flex-wrap">
                    <button type="submit" class="btn btn-primary reply-btn">Send Reply</button>
                    <a href="${pageContext.request.contextPath}/admin/inbox" class="btn btn-outline-secondary secondary-btn">Back to Inbox</a>
                </div>
            </form>
        </div>
