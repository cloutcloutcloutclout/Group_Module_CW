...
<head>
    ...
    <style>
        ...
        /* New style to align the delete button next to the others */
        .action-buttons {
            display: flex;
            gap: 10px;
            align-items: center;
...
<section class="edit-section">
    <div class="container">
        ...
        <form:form action="${pageContext.request.contextPath}/editAccount/${user.id}" modelAttribute="user" method="post">
            ...
            <input type="email" name="confirmEmail" id="confirmEmailField"/>
            <form:errors path="confirmEmail" cssClass="error"/><br/><br/>

            <label>New Password:</label>
            <input type="password" name="passwordHash" id="passwordField" autocomplete="new-password"/>
            <form:errors path="passwordHash" cssClass="error"/><br/><br/>

            <label>Confirm New Password:</label>
            <input type="password" name="confirmPassword" id="confirmPasswordField" autocomplete="new-password"/>
            <form:errors path="confirmPassword" cssClass="error"/><br/><br/>

            <div class="action-buttons">
                <button type="submit" class="btn btn-primary">Save Changes</button>
                <a href="${pageContext.request.contextPath}/account" class="btn btn-secondary">Return to Account Details</a>
            </div>

        </form:form>

        <div class="action-buttons" style="margin-top: 30px; border-top: 1px solid #ccc; padding-top: 20px;">
            <p class="text-danger fw-bold mb-0 me-3">Danger Zone:</p>
            <form action="${pageContext.request.contextPath}/deleteAccount/${user.id}" method="post"
